...
if __name__=="__main__":
    ...
    # data
    parser.add_argument('--data_dir', type=str, default='data/SF_1n', help='data directory. Should contain train.txt/valid.txt/test.txt with input data')
    # model params
    parser.add_argument('--rnn_size', type=int, default=150, help='size of LSTM internal state')
    ...
    parser.add_argument('--feature_maps', type=int, nargs='+', default=[25,50,75,100,100,200], help='number of feature maps in the CNN')
    parser.add_argument('--kernels', type=int, nargs='+', default=[1,2,3,4,5,6], help='conv net kernel widths')
